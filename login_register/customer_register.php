...
if ( isset($_POST['sub'])){
	...
	$state=$_POST['stat'];
	$place=$_POST['place'];
	$sql = "INSERT INTO customer_info (cust_pwd, cust_email, cust_Fname, cust_Lname, cust_gender, cust_phone, cust_state, cust_place, cust_address) VALUES ('$pass', '$mail', '$fn', '$ln', '$sex', '$num', '$state', '$place', '$add')"; //this is query for registration
